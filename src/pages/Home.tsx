    ...
    <>
      <div className="content content-dashboard">
        <div className="content home">
          <section>
            ...
            <article>
              ZENVYA transforme vos données quotidiennes en insights profonds
              pour optimiser votre bien-être, finances, et carrière — sans
              l'agression visuelle du tech.
              <p className="espacement">
                <span className="begin-free">
                  <Link to="">Commencer gratuitement &rarr;</Link>
                </span>
                <span className="demo">
                  <Link to="">Voir la d&eacute;mo &rarr;</Link>
                </span>
              </p>
          ...
          <section className="adjust">
            ...
            <article className="activity recommendation">
              <div>
                ...
                <p>
                  Vos meilleures performances arrivent après 7h+ de sommeil.
        ...
        <section className="dashboard information">
          ...
          <p style={{ width: "100%" }}>
            Santé, finances, productivité et carrière — analysés et corrélés par
            IA
          </p>
          <article>
      ...
      <div className="content home">
        <section>
          ...
          <article>
            Notifications contextuelles basées sur vos patterns comportementaux.
            Pas de spam, juste des insights au bon moment.
            <p className="hour">
              <span>08:30</span>
              Votre énergie est à son pic. Bloquez 2h pour votre projet
              prioritaire.
            </p>
            <p className="hour">
              <span>14:00</span>
            ...
            <p className="hour">
              <span>21:30</span>
              Qualité de sommeil optimale après une session sport. Prévue
              demain?
            </p>
          </article>
        </section>
        <section>
          <aside>
            <picture className="limit photo">
              <img src="photo/photo-1759752394755-1241472b589d.webp" />
            </picture>
          </aside>
        </section>
        <section className="dashboard information career">
          ...
          <p className="center">
            CV scoring, job matching intelligent, et insights sur votre
          ...
          <p className="center">
            <span className="testing">
              <Link to="">Analyser mon CV maintenant &rarr;</Link>
            </span>
          </p>
        </section>
        <section className="conclusion">
          ...
          <p>
            Rejoignez les 10,000+ personnes qui optimisent leur vie avec ZENVYA
          </p>
          <p>
            <span className="testing">
              <Link to="">Commencer gratuitement &rarr;</Link>
